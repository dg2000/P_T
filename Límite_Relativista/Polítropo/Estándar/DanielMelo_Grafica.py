...
plt.ylabel("w")
plt.legend(loc=0)
plt.savefig("n="+str(r[a-1])+"|m="+str(y1[a-1])+"|a="+str(y1[a-2])+"|b="+str(y2[a-2])+"(w_vs_z).png")
...
plt.ylabel("w'")
plt.legend(loc=0)
plt.savefig("n="+str(r[a-1])+"|m="+str(y1[a-1])+"|a="+str(y1[a-2])+"|b="+str(y2[a-2])+"(w'_vs_z).png")
...
plt.ylabel("w'")
plt.legend(loc=0)
plt.savefig("n="+str(r[a-1])+"|m="+str(y1[a-1])+"|a="+str(y1[a-2])+"|b="+str(y2[a-2])+"(w'_vs_w).png")
